...
//         _generatePropertyMessage(propertyTitle, propertyLocation, propertyPrice,
//             propertyImageUrl, categoryName);
...
//       displayPhone =
//           '+${displayPhone.substring(0, 2)} ${displayPhone.substring(2)}';
...
//     print("kkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkkk$category");
//     // 🏢 COMPANY
//     if (category == 'companies') {
//       return 'Hi, I am interested in your company "${title ?? ''}".\n'
//           'Location: ${location ?? ''}.\n'
//           'Could you please share more details about your services?';
//     }

//     // 🏬 GOLD SHOP
//     if (category == 'gold shops') {
//       return 'Hi, I am interested in your shop "${title ?? ''}".\n'
//           'Location: ${location ?? ''}.\n'
//           'Can you share latest gold rates and designs?';
//     }
...
//     String? price,
//     String? imageUrl,
//     String? categoryName, // ✅ FIXED
//   ) {
//     final category = categoryName?.toLowerCase() ?? '';
//     print("kkkkkkkkkkkhhhhhhhhhhhhhhhhhhhhhhhhhhhh$category");
//     // 🏢 COMPANY
//     if (category == 'companies') {
//       return '🏢 *$title*\n\n'
//           '📍 Location: $location\n\n'
//           'I want more about your services. Please share more details.';
//     }
...
//       return '🏬 *$title*\n\n'
//           '📍 Location: $location\n\n'
//           'Please share latest gold rates and available designs.';
//     }
...
class WhatsAppUtils {
  ...
  static Future<void> openWhatsApp({
    ...
    try {
      ...
      String encodedMessage = Uri.encodeComponent(finalMessage);
      String formattedPhone = _formatPhoneNumber(phoneNumber);

      String url;

      if (Platform.isAndroid || Platform.isIOS) {
        url = formattedPhone.isNotEmpty
  ...
  static String _generateDefaultMessage(
    ...
    if (category == 'gold shops') {
      return 'Hi, I am interested in your shop "${title ?? ''}".\n'
          '📍 Location: ${location ?? ''}\n'
          'Please share latest gold rates and designs.';
    }

    // 🏠 PROPERTY
    String message = 'Hi, I am interested in "$title"';
  ...
  static String _generatePropertyMessage(
    ...
    if (category == 'companies') {
      return '🏢 *$title*\n\n'
          '📍 Location: $location\n\n'
          'I am interested in your services. Please share more details.';
    }
              ...
              ListTile(
                ...
                onTap: () {
                  ...
                  shareProperty(
                    ...
                    propertyPrice: propertyPrice,
                    agentPhone: phoneNumber,
                    categoryName: categoryName, // ✅ FIXED
                  );
                },
              ),
            ],
