...
class LocationProvider extends ChangeNotifier {
  ...
  Future<void> loadSavedLocation() async {
    try {
      ...
      if (savedLocation != null && 
        ...
        notifyListeners();
        print("Loaded saved location: ${savedLocation['latitude']}, ${savedLocation['longitude']}");
      }
    } catch (e) {
      print('Error loading saved location: $e');
    }
  ...
  Future<void> getCurrentLocation() async {
    ...
    try {
      ...
      if (_currentPosition == null) {
        ...
        print("Got current location: ${_currentPosition!.latitude}, ${_currentPosition!.longitude}");
      }
    } catch (e) {
      _errorMessage = e.toString();
  ...
  Future<bool> updateLocationToServer() async {
    ...
    try {
      ...
      print("Updating location to server: ${_currentPosition!.latitude}, ${_currentPosition!.longitude}");
      ...
      print("Update response: $_updateResponse");

      if (_updateResponse!['success'] == true) {
        return true;
      } else {
        _errorMessage = _updateResponse!['message'] ?? 'Failed to update location';
        return false;
      }
    } catch (e) {
      _errorMessage = e.toString();
