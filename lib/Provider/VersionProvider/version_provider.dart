...
class VersionProvider extends ChangeNotifier {
  ...
  Future<void> checkVersion() async {
    ...
    try {
      ...
      print(
          "ooooooooooooooooooooooooooooooooooooooooooooooooooooooo${status?.storeVersion}");
      if (status != null) {
        ...
        print(
            "ooooooooooooooooooooooooooooooooooooooooooooooooooooooo${status?.canUpdate}");
        print(
            "ooooooooooooooooooooooooooooooooooooooooooooooooooooooo$needsUpdate");
        notifyListeners();
      } else {
        needsUpdate = false;
        notifyListeners();
