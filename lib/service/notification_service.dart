...
//     // Initialize with settings - FIXED: Using named parameters correctly
//     await _localNotifications.initialize(
//       settings: initSettings, // ← FIXED: Added 'settings:' named parameter
...
//   // Create notification channel for Android (Android 8.0+)
...
//     // Show notification - FIXED: Using named parameters correctly
//     await _localNotifications.show(
//       id: 0, // ← FIXED: Added 'id:' named parameter
//       title: title, // ← FIXED: Added 'title:' named parameter
//       body: body, // ← FIXED: Added 'body:' named parameter
//       notificationDetails: details, // ← FIXED: Added 'notificationDetails:' named parameter
//       payload: payload,
//     );
//   }
...
//         print('Navigate to product detail: ${data['productId']}');
//         break;
//       case 'offer':
//         print('Navigate to offers screen');
//         break;
//       case 'broadcast':
