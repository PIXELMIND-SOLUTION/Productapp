...
//         Uri.parse('https://estatehouz-backend.onrender.com/api/${widget.productId}'),
//         headers: {
...
//     final phoneNumber = _userData?['mobile'] ?? '919961593179';
...
//     if (_userData != null) {
//       if (_userData!['name'] != null) text.writeln('👤 Agent: ${_userData!['name']}');
//       if (_userData!['mobile'] != null) text.writeln('📱 Phone: ${_userData!['mobile']}');
//     } else {
//       text.writeln('📱 Contact agent for more details');
//     }
...
//                       color: Colors.white,
//                       errorBuilder: (_, __, ___) {
//                         return const Icon(Icons.chat, color: Colors.white, size: 16);
//                       },
//                     ),
//                     const SizedBox(width: 6),
//                     const Text(
