...
// Story Card Widget (Circle instead of Square)
class StoryCard extends StatelessWidget {
  final StoryGroup storyGroup;
  final VoidCallback onTap;
  final String currentUserId;
...
// Stories List Widget (Horizontal Scroll with Light Cream Background)
class StoriesListWidget extends StatelessWidget {
  final List<StoryGroup> storyGroups;
  final VoidCallback onAddStory;
  final Function(StoryGroup) onStoryTap;
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      color: const Color(0xFFFFF8E7), // Light cream background
      child: SizedBox(
        height: 110,
        child: ListView(
          scrollDirection: Axis.horizontal,
            ...
            body: GestureDetector(
              ...
              child: Stack(
                children: [
                  ...
                  // ── Bottom-Right Vertical Action Bar (Like, Comment, Share) ──
                  // Now includes for current user's stories as well
                  Positioned(
                    right: 16,
                    bottom: 110,
                    child: Column(
                      ...
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            ...
                            await Share.share(
                              story.mediaUrl,
                              subject: story.caption ?? 'Check out this story!',
                            );
                            _resumeTimer();
                          },
                          child: Column(
