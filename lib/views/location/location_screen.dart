...
class _LocationScreenState extends State<LocationFetchScreen> 
  ...
  Future<void> _loadGoogleApiKey() async {
    try {
      ...
      _googleApiKey = 'AIzaSyDaJzdZ5-Q2Lv2KArStqAtGXf4SukdHwig';
  ...
  @override
  Widget build(BuildContext context) {
    print('User ID in LocationScreen: ${widget.userId}');
    final theme = Theme.of(context);
    final isDark = theme.brightness == Brightness.dark;
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    // Google Places Search with API Key
                    SlideTransition(
                      position: _slideAnimation,
                      child: FadeTransition(
                        opacity: _fadeAnimation,
                        child: Container(
                          ...
                          child: GooglePlaceAutoCompleteTextField(
                            textEditingController: _searchController,
                            focusNode: _focusNode,
                            googleAPIKey: _googleApiKey.toString(),
                            inputDecoration: InputDecoration(
                              contentPadding: const EdgeInsets.symmetric(
                                horizontal: 20,
                                vertical: 18,
